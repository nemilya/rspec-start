...
Сохраним файл. Если у нас стартован `autotest` то 
...
Добавляем код в файл `spec/spec_helper.rb`, перед блоком `RSpec.configure do |config|`:
